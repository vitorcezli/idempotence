...
import com.example.idempotence.agents.IdempotenceAgent;
import com.example.idempotence.annotations.Idempotent;
import com.example.idempotence.filter.ParameterFilter;
import com.example.idempotence.filter.ParameterFilterException;
import com.example.idempotence.hash.HashingStrategy;
import com.example.idempotence.logging.IdempotenceLogger;
import com.example.idempotence.payload.PayloadSerializer;
...
public class IdempotenceAspect {
    ...
    @Around("@annotation(com.example.idempotence.annotations.Idempotent)")
